...
import com.example.mangareader.Models.comicModel;
import com.example.mangareader.comic_activity;
...
public class comicAdapter extends RecyclerView.Adapter<comicAdapter.ViewHolder> {
    ...
    public comicAdapter(Context context, ArrayList<comicModel> list){
        mContext = context;
        mList = list;
    }
